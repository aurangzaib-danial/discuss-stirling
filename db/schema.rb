...
ActiveRecord::Schema.define(version: 2022_02_01_224051) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "account_selected", default: false, null: false
    t.integer "email_notifications_frequency", default: 0, null: false
